...
for imagePath in imagePaths:
	...
	# loading the input image into size (224x224) and preprocess it
...
# partitioning the data into training and testing splits using 80% for training and 20% for testing

(trainX, testX, trainY, testY) = train_test_split(data, labels,
	test_size=0.20, stratify=labels, random_state=42)

# constructing the training image generator for data preprocessing purpose
...
# placed the head model on top of the base model
model = Model(inputs=baseModel.input, outputs=headModel)

# looping over all layers in the base model
